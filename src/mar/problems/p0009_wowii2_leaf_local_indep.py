...
出発点は**二重星定理** (定理 3.2): 連結グラフの**すべての辺** $uv$ で
$L_s(G) \ge |N(u) \cup N(v)| - 2$。これは**既知**の下界で、WOWII の予想 178
(2005-08-08) の注記に出題者自身が「容易に導ける」と書いている
(2026-07-27 に一次資料で確認)。本稿では自己完結のため部分木延長補題
(補題 3.1) だけを使う証明を与える。
